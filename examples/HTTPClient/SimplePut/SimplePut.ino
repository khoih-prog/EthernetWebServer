/****************************************************************************************************************************
  SimplePut.ino - Simple Arduino web server sample for Ethernet shield
...
void setup()
{
  ...
  SerialDebug.print("\nStarting SimplePut on "); SerialDebug.print(BOARD_NAME);
...
void loop() 
{
  SerialDebug.println("making PUT request");
