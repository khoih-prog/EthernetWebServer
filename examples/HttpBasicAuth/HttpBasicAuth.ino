...
#define USE_THIS_SS_PIN   10    // For other boards
  ...
  SerialDebug.print(F("Open http://"));
  SerialDebug.print(Ethernet.localIP());
  SerialDebug.println(F("/ in your browser to see it working"));
  SerialDebug.print(F("Using username : "));
  SerialDebug.print(www_username);
  SerialDebug.print(F(" and password : "));
  SerialDebug.println(www_password);
}
